...
public class Base64Decoder {
	...
	public static String decode(String base64Text) {
		...
		return decode(base64Text, Base64Encoder.NUM_TO_BASE64_CHAR);
	}
	 ...
	 * @return The text that has been encoded by the input
	 */
	public static String decode(String base64Text, char[] base64Chars) {
	 ...
	 * @return The text that has been encoded by the input
	 */
	public static String decodeToHexStr(String base64Text) {

		return decodeToHexStr(base64Text, Base64Encoder.NUM_TO_BASE64_CHAR);
	}
	 ...
	 * @return The text that has been encoded by the input
	 */
	public static String decodeToHexStr(String base64Text, char[] base64Chars) {

		return decodeToHexStr(base64Text, base64Chars, CHAR_TO_HEX_DIGIT);
	}
	 ...
	 * @return The text that has been encoded by the input
	 */
	public static String decodeToHexStr(String base64Text, char[] base64Chars, char[] hexChars) {
