...
public class BinaryEncoder {
	 ...
	 * @return A string representation of the number in binary
	 */
	public static String encode(String number, Integer digits) {

		try {

			long actualNumber = Long.valueOf(number);
			return encode(actualNumber, digits);
	 ...
	 * @return A string representation of the number in binary
	 */
	public static String encode(long number, Integer digits) {
