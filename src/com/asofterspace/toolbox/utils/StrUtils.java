...
public class StrUtils {
	...
	public static void sortNumerically(List listToSort) {
		sortNumerically(listToSort, new Stringifier() {
	...
	public static void sortNumerically(List<?> listToSort, Stringifier stringifier) {
		...
		Collections.sort(listToSort, new Comparator<Object>() {
			...
			public int compare(Object a, Object b) {
				...
				String bLow = stringifier.getString(b).toLowerCase();
				String aLow = stringifier.getString(a).toLowerCase();
